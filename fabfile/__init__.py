...
env.application_name = 'frcportal'   # name of webapp
env.root_package_name = 'portal_frc'  # name of app in webapp
...
# git repository url
env.remote_repo_url = 'git@git.unistra.fr:di/portail-icfrc.git'
...
def dev():
    ...
    env.server_name = 'dryb17-dev.net'
    env.short_server_name = 'dryb17-dev'
...
def test():
    ...
    env.server_name = 'portail-icfrc-test.u-strasbg.fr'
    env.short_server_name = 'portail-icrfc-test'
    env.static_folder = '/site_media/'
    env.server_ip = ''
    env.no_shared_sessions = False
...
def preprod():
    ...
    env.roledefs = {
        'web': ['dryb17-pprd.net'],
        'lb': ['lb.dryb17-pprd.net'],
    }
    # env.user = 'root'  # user for ssh
    env.backends = env.roledefs['web']
    env.server_name = 'dryb17-pprd.net'
    env.short_server_name = 'dryb17-pprd'
    env.static_folder = '/site_media/'
    env.server_ip = ''
    env.no_shared_sessions = False
    env.server_ssl_on = True
